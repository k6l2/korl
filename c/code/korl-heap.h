...
#define KORL_HEAP_ENUMERATE(name)                      void name(fnSig_korl_heap_enumerateCallback* callback, void* callbackUserData, void* heap)// @TODO: fix this param order inconsistency... :|
