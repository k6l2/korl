...
#define string_newFormatUtf16(formatUtf16, ...)                                korl_stringPool_newFormatUtf16(_LOCAL_STRING_POOL_POINTER, __FILEW__, __LINE__, L"" formatUtf16, ##__VA_ARGS__)
...
#define string_appendFormatUtf16(stringHandle, formatUtf16, ...)               korl_stringPool_appendFormatUtf16(_LOCAL_STRING_POOL_POINTER, stringHandle, __FILEW__, __LINE__, L"" formatUtf16, ##__VA_ARGS__)
