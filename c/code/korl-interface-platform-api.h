...
_KORL_PLATFORM_API_MACRO_OPERATION(korl_command_register)
...
//KORL-ISSUE-000-000-115: platform-api: remove all these string functions from platform API; move them all to korl-string (except maybe platform-specific implementations, like C string formatting)
...
_KORL_PLATFORM_API_MACRO_OPERATION(korl_memory_stringCompare)
_KORL_PLATFORM_API_MACRO_OPERATION(korl_memory_stringCompareUtf8)
_KORL_PLATFORM_API_MACRO_OPERATION(korl_memory_stringSize)
_KORL_PLATFORM_API_MACRO_OPERATION(korl_memory_stringSizeUtf8)
_KORL_PLATFORM_API_MACRO_OPERATION(korl_memory_stringCopy)
_KORL_PLATFORM_API_MACRO_OPERATION(korl_memory_stringFormatVaList)
_KORL_PLATFORM_API_MACRO_OPERATION(korl_memory_stringFormatVaListUtf8)
_KORL_PLATFORM_API_MACRO_OPERATION(korl_memory_stringFormatBuffer)
