...
///@TODO: remove all these string functions from platform API; move them all to korl-string (except maybe platform-specific implementations, like C string formatting)
