...
// _KORL_PLATFORM_API_MACRO_OPERATION(korl_gfx_font_getMetrics)// @TODO: remove; useless API, since text generation all happens in the platform layer anyway?...
_KORL_PLATFORM_API_MACRO_OPERATION(korl_gfx_font_getResources)
_KORL_PLATFORM_API_MACRO_OPERATION(korl_gfx_font_getTextMetrics)
_KORL_PLATFORM_API_MACRO_OPERATION(korl_gfx_font_generateText)
