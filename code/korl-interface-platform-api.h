...
_KORL_PLATFORM_API_MACRO_OPERATION(korl_gfx_font_getResources)
_KORL_PLATFORM_API_MACRO_OPERATION(korl_gfx_font_getUtf8Metrics)
_KORL_PLATFORM_API_MACRO_OPERATION(korl_gfx_font_generateUtf8)
_KORL_PLATFORM_API_MACRO_OPERATION(korl_gfx_font_getUtf16Metrics)
_KORL_PLATFORM_API_MACRO_OPERATION(korl_gfx_font_generateUtf16)
...
_KORL_PLATFORM_API_MACRO_OPERATION(_korl_resource_descriptor_add)
_KORL_PLATFORM_API_MACRO_OPERATION(korl_resource_fromFile)
_KORL_PLATFORM_API_MACRO_OPERATION(korl_resource_buffer_create)
