...
_KORL_PLATFORM_API_MACRO_OPERATION(korl_gfx_getSwapchainImageView)
_KORL_PLATFORM_API_MACRO_OPERATION(korl_gfx_newTransientPass)
_KORL_PLATFORM_API_MACRO_OPERATION(korl_gfx_newTransientFramebuffer)
_KORL_PLATFORM_API_MACRO_OPERATION(korl_gfx_pass_submit)
...
_KORL_PLATFORM_API_MACRO_OPERATION(korl_math_f32_quietNan)
_KORL_PLATFORM_API_MACRO_OPERATION(korl_math_f32_infinity)
...
_KORL_PLATFORM_API_MACRO_OPERATION(korl_resource_getRawRuntimeData)
...
_KORL_PLATFORM_API_MACRO_OPERATION(korl_resource_scene3d_getMeshTriangles)
