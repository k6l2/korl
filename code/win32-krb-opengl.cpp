...
internal void w32KrbOglInitialize(HWND hwnd)
{
	...
	KORL_OGL_GET_EXTENSION_API(PFNGLBLENDEQUATIONPROC, glBlendEquation);
	KORL_OGL_GET_EXTENSION_API(PFNGLBLENDFUNCSEPARATEPROC, glBlendFuncSeparate);
	...
	KORL_OGL_GET_EXTENSION_API(PFNGLDETACHSHADERPROC, glDetachShader);
	...
	KORL_OGL_GET_EXTENSION_API(PFNGLUNIFORMMATRIX4FVPROC, glUniformMatrix4fv);
	KORL_OGL_GET_EXTENSION_API(
		PFNGLGETUNIFORMLOCATIONPROC, glGetUniformLocation);
	KORL_OGL_GET_EXTENSION_API(
		PFNGLBLENDEQUATIONSEPARATEPROC, glBlendEquationSeparate);
	KORL_OGL_GET_EXTENSION_API(PFNGLGETATTRIBLOCATIONPROC, glGetAttribLocation);
	...
	KORL_OGL_GET_EXTENSION_API(PFNGLBINDSAMPLERPROC, glBindSampler);
