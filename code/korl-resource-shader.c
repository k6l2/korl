...
korl_internal void korl_resource_shader_register(void)
{
    ...
    descriptorManifest.callbackUnload     = korl_functionDynamo_register(_korl_resource_shader_unload);
    descriptorManifest.callbackTranscode  = korl_functionDynamo_register(_korl_resource_shader_transcode);
