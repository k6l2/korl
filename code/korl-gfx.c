...
korl_internal KORL_FUNCTION_korl_gfx_font_getTextMetrics(korl_gfx_font_getTextMetrics)
{
...
korl_internal KORL_FUNCTION_korl_gfx_font_generateText(korl_gfx_font_generateText)
{
    _Korl_Gfx_Context*const context = _korl_gfx_context;
    _Korl_Gfx_FontCache*const fontCache = _korl_gfx_matchFontCache(utf16AssetNameFont, textPixelHeight, 0.f/*textPixelOutline*/);
    if(!fontCache)
...
korl_internal KORL_FUNCTION_korl_gfx_batch(korl_gfx_batch)
{
    ...
    blend.color.operation    = batch->blend.color.operation;
    blend.color.factorSource = batch->blend.color.factorSource;
    blend.color.factorTarget = batch->blend.color.factorTarget;
    blend.alpha.operation    = batch->blend.alpha.operation;
    blend.alpha.factorSource = batch->blend.alpha.factorSource;
    blend.alpha.factorTarget = batch->blend.alpha.factorTarget;
