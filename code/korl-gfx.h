...
typedef struct Korl_Gfx_Text
{
    ...
    f32                         textPixelHeight;
    u32                         assetNameFontRawUtf16ByteOffset;
    u32                         assetNameFontRawUtf16Size;
...
#define korl_gfx_text_getUtf16AssetNameFont(context) (KORL_STRUCT_INITIALIZE(acu16){(context)->assetNameFontRawUtf16Size\
                                                                                   ,KORL_C_CAST(u16*, KORL_C_CAST(u8*, (context)) + context->assetNameFontRawUtf16ByteOffset)})
