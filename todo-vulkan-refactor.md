...
[ ] add KORL_GFX_DRAWABLE_TYPE_BUFFERED type; 
    [ ] expose korl-resource APIs for buffer create/destroy/update; 
    [ ] augment korl-utility-gfx APIs to allow create/destroy/update _BUFFERED Drawables;
    [ ] augment korl_gfx_draw to support _BUFFERED Drawables
