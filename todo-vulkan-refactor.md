...
[x] finish @TODOs
[x] refactor korl-utility-gfx to use new Korl_Gfx_CreateInfoRuntimeDrawable & korl_gfx_drawable_attribute* API concepts
[x] ensure usability/versatility of the new rendering APIs by integrating this branch with a more fleshed out project, such as the `farm` project
